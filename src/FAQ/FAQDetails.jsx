...
function FAQDetails() {
  ...
  const questions = [
    {
      text: "เวลาในการให้บริการ",
      icon: true,
      content: "สามารถเรียกใช้ได้ 24 ชั่วโมง",
    },
    {
      text: "ต้องเตรียมอะไรบ้างก่อนใช้บริการ",
      icon: true,
      content: "เอกสารเบื้องต้น เช่น ทะเบียนรถ",
    },
    {
      text: "ต้องโทรติดต่อรถสไลด์อย่างไร",
      icon: true,
      content: "สามารถโทรและแชทผ่านแอปได้",
    },
    {
      text: "บริการรถสไลด์ในทุกพื้นที่หรือไม่",
      icon: true,
      content:
        "บริการรถสไลด์มักจะมีให้ในพื้นที่ส่วนใหญ่ โดยเฉพาะในเขตเมืองใหญ่",
    },
  ];
  ...
  return (
    <div className="payment-details-container">
      ...
      <h6 className="question-con">FAQ</h6>
